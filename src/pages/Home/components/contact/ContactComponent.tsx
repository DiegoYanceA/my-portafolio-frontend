...
function ContactComponent({ user, trans }: Readonly<ContactProps>) {
  ...
  return (
    <div id="contact" className="section contact h-screen-fix lg:h-screen justify-center flex" data-title={trans?.text}>
      <div className="section-scroll contact__container h-full w-full grid grid-cols-1 lg:grid-cols-12 py-14 md:py-5 lg:py-10 px-4 md:px-28 lg:px-28">
        ...
        <div className="contact__information rounded-r-lg lg:col-span-7 p-3 lg:p-0">
          <div className="grid grid-cols-1 content-center h-full gap-y-5 md:p-5">
            <div>
